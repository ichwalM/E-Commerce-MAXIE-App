        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
                ...
                @if(Auth::user()->role === 'admin')
                    ...
                    <a href="{{ route('chat.index') }}" class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 group {{ request()->routeIs('chat.*') ? 'bg-white/20 shadow-inner' : 'hover:bg-white/10' }}">

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-bold mb-4 text-[#99010A]">Order History</h3>
                        ...
                        <table class="min-w-full bg-white border border-gray-300">
                            <thead>
                                <tr class="bg-[#FEFBEC] text-left">
                                    ...
                                    <th class="py-2 px-4 border-b">Seller (Distributor)</th>
                            ...
                            <tbody>
                                @foreach($orders as $order)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-4 border-b">{{ $order->seller->name }}</td>
                                        ...
                                        <td class="py-2 px-4 border-b">
                                            <a href="{{ route('customer.orders.show', $order) }}" class="text-blue-600 hover:underline text-sm">View Details</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>

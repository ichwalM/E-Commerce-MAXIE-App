                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-start border-b pb-6 mb-6">
                        ...
                        <div class="text-right">
                             <p class="text-sm text-gray-500">Seller (Distributor)</p>
                             <p class="font-bold text-lg">{{ $order->seller->name }}</p>
                        </div>
                    </div>

                    <!-- Order Items -->
                    <h3 class="text-lg font-semibold mb-4 text-[#99010A]">Items Purchased</h3>
                    ...
                    @if($order->notes)
                        <div class="mb-8 p-4 bg-gray-50 rounded-lg border">
                            <h4 class="font-bold text-sm text-gray-700 mb-2">My Notes:</h4>
                    ...
                    <div class="flex justify-end space-x-4 border-t pt-6">
                        <a href="{{ route('customer.orders.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 transition">
                            Back to My Orders
                        </a>

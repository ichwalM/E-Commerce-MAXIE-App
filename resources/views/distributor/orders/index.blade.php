            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-bold text-[#99010A]">My Orders</h3>
                        <a href="{{ route('distributor.orders.create') }}" class="px-4 py-2 bg-[#99010A] text-white rounded hover:bg-red-800">
                            + New Request
                        </a>
                    </div>
                            ...
                            <tbody>
                                @foreach($orders as $order)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-4 border-b">
                                            <a href="{{ route('distributor.orders.show', $order) }}" class="text-blue-600 hover:underline text-sm">View Details</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>

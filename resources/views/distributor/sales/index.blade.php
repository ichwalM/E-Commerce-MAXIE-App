        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-bold mb-4 text-[#99010A]">Customer Orders</h3>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white border border-gray-300">
                            ...
                            <tbody>
                                @foreach($orders as $order)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="py-2 px-4 border-b">
                                            <a href="{{ route('distributor.sales.show', $order->id) }}" class="text-blue-600 hover:underline text-sm">Manage</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                         ...
                         @if($orders->isEmpty())
                            <div class="text-center py-8 text-gray-500">No incoming orders yet.</div>
                        @endif
                    </div>
                </div>
            </div>

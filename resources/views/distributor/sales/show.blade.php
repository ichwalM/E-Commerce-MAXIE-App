                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <p class="mt-2">Customer: <strong>{{ $order->buyer->name }}</strong></p>
                        </div>
                    ...
                    <div class="flex justify-end gap-4 mt-8 border-t pt-4">
                         <form action="{{ route('distributor.sales.update', $order->id) }}" method="POST" onsubmit="return confirm('Reject and Cancel this order?');">
                            @csrf
                            @method('PUT')
                        ...
                        <form action="{{ route('distributor.sales.update', $order->id) }}" method="POST" onsubmit="return confirm('Complete and Process this order? This will deduct your stock.');">
                            @csrf
                            @method('PUT')
                    ...
                    <div class="mt-4">
                        <a href="{{ route('distributor.sales.index') }}" class="text-sm text-gray-600 hover:underline">&larr; Back to Sales</a>
                    </div>
                </div>
             </div>
        </div>

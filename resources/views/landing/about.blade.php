<x-guest-layout>
    ...
    <section class="relative pt-32 pb-20 overflow-hidden bg-white">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <span class="inline-block py-1 px-3 rounded-full bg-red-50 text-[#99010A] text-xs font-semibold tracking-wide uppercase mb-6">
                    About Maxie Skincare
                </span>
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight font-serif">
                    ...
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                        ...
                        <div class="aspect-[4/5] bg-gradient-to-br from-gray-200 to-gray-300 w-full object-cover">
                             <div class="absolute inset-0 flex items-center justify-center text-gray-400">
                                <img src="{{ asset('images/hero2.webp') }}" alt="About Us" class="w-full h-full object-cover">
                             </div>
                        </div>
                    </div>
                </div>
                <div class="w-full md:w-1/2">
                    <h2 class="text-3xl font-bold text-gray-900 mb-6 font-serif">The Maxie Philosophy</h2>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                <!-- Vision -->
                <div class="bg-white p-10 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition duration-300 group">
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-3xl font-bold text-gray-900 mb-12 font-serif">Why Choose Maxie?</h2>
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="p-6">
                    <div class="mx-auto w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mb-6 text-[#99010A]">
    ...
    <section class="py-20 bg-[#99010A] text-white">
        <div class="container mx-auto px-6 text-center">
            <h2 class="text-3xl md:text-4xl font-bold mb-6">Ready to Glow with Us?</h2>
            <p class="text-red-100 mb-8 max-w-xl mx-auto text-lg">Join thousands of others who have transformed their skin and their lives with Maxie Skincare.</p>
            <div class="flex justify-center gap-4">
                <a href="{{ route('customer.products.index') }}" class="px-8 py-3 bg-white text-[#99010A] font-bold rounded-lg hover:bg-red-50 transition shadow-lg">
                    Shop Now
                </a>
                <a href="{{ route('register') }}" class="px-8 py-3 bg-transparent border border-white text-white font-bold rounded-lg hover:bg-white/10 transition">
                    Join as Partner
                </a>
            </div>
        </div>

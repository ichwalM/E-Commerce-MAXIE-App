<x-guest-layout>
    ...
    <div class="bg-gray-50 pt-32 pb-12">
        <div class="container mx-auto px-6 text-center">
            <span class="text-[#99010A] font-bold tracking-widest uppercase text-xs mb-3 block">{{ __('Our Collection') }}</span>
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 font-serif">{{ __('Shop All Products') }}</h1>

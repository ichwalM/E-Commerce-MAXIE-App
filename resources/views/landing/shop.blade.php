<x-guest-layout>
    ...
    <div class="bg-gray-50 pt-32 pb-12">
        <div class="container mx-auto px-6 text-center">
            <span class="text-[#99010A] font-bold tracking-widest uppercase text-xs mb-3 block">Our Collection</span>
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 font-serif">Shop All Products</h1>
            <p class="text-gray-500 mt-4 max-w-xl mx-auto">Discover our full range of premium skincare solutions, scientifically formulated to reveal your natural glow.</p>
        </div>
    </div>
        ...
        @else
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
                @foreach($products as $product)
                    <div class="group bg-white rounded-xl overflow-hidden border border-gray-100 hover:shadow-xl transition duration-300">
                        <!-- Image -->
